    ...
    try {
        ...
        if (result === "REGISTERED") {
            ...
            if (result.startsWith("VALIDATION_ERROR:")) {
                errorMsg = result.replace("VALIDATION_ERROR:", "").trim();
            } else if (result.startsWith("REGISTER_FAIL:")) {
                errorMsg = "Server error: " + result.replace("REGISTER_FAIL:", "").trim();
            } else if (result === "OTP_NOT_VERIFIED") {
                errorMsg = "Please verify your email with OTP first.";
            } else if (result === "OTP_EXPIRED") {
                errorMsg = "OTP verification expired. Please verify again.";
            }
